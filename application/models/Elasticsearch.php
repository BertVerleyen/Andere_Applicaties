<?php
/*******methodes voor de implementatie van elasticsearch
 -> wordt niet meer gebruikt door bug binnen elasticsearch*******/
class Application_Model_Elasticsearch
{
    public $index = 'surveyanyplace_rc1';
